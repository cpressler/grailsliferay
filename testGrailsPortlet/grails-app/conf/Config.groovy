...
liferay {
    ...
    plugin_package {
        ...
        change_log=''
        page_uri=''
        author='Chet Pressler'
        license='Proprietary'
    }
}

// NEED to define these here as well to match the PortletClass Otherwise you get 
// an UnSupported public render parameter on deployment into liferay
...
liferay {
	public_render_parameters = [
		"prp-1":"com.mycompany.public-param-1",
                "prp-2":"com.mycompany.public-param-2"
		]
}
