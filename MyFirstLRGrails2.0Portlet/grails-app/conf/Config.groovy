...
environments {
    production {
         //log4j.appender.'errors.File'="grail_strace.log" 
...
liferay {
    ...
    plugin_package {
        name = "${appName}"
        module_group_id = 'MyModule2'
        module_incremental_version = '1'
        tags='sample'
        short_description='a short description grails 2'
        change_log=''
        page_uri=''
        author='Joe Bloe '
        license='Proprietary'
...
liferay {
	events = [
		"event-1": [:],
		"event-2": [type:"com.mycompany.events.Event2"]
		]
}

liferay {
	public_render_parameters = [
		"prp1":"com.mycompany.public-param-1",
        "prp2":"com.mycompany.public-param-2"
		]
}